...
@property (nonatomic,assign)CGSize size;//collectionview
...
-(void)refresh:(UITableView*)tableView page:(NSUInteger)page complete:(void(^)(NSArray* _Nullable modelRect, BOOL finished))complete;
