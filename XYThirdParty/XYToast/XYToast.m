...
- (id)initWithText:(NSString *)text_{
    if (self = [super init]) {
        ...
        _textLabel = [[UILabel alloc] initWithFrame:CGRectMake(10, 0, textWidth, textHeight)];
        ...
        contentView = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, self.textLabel.frame.size.width+20, self.textLabel.frame.size.height)];
        contentView.layer.cornerRadius = 5.0f;
        contentView.layer.borderWidth = 1.0f;
        contentView.layer.borderColor = [[UIColor grayColor] colorWithAlphaComponent:0.5].CGColor;
        contentView.backgroundColor = [UIColor colorWithRed:0
                                                      green:0
                                                       blue:0
                                                      alpha:0.75f];
...
+ (XYToast*)showWithText:(NSString *)text_ {
    return [XYToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
    
}

+ (XYToast*)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    XYToast *toast = [[XYToast alloc] initWithText:text_];
    [toast setDuration:duration_];
    [toast show];
    return toast;
}
+ (XYToast*)showWithText:(NSString *)text_  inView:(UIView*)view{
    return [XYToast showWithText:text_ inView:view duration:DEFAULT_DISPLAY_DURATION];
...
+ (XYToast*)showWithText:(NSString *)text_
   ...
   return [XYToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (XYToast*)showWithText:(NSString *)text_
     ...
     return [XYToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
